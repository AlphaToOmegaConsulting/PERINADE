...
const vins = defineCollection({
  loader: glob({ pattern: "**/*.yaml", base: "./src/content/vins" }),
  schema: ({ image }) =>
    z.object({
      nom: z.string(),
...
const coffrets = defineCollection({
  loader: glob({ pattern: "**/*.yaml", base: "./src/content/coffrets" }),
  schema: ({ image }) =>
    z.object({
      nom: z.string(),
      meta: z.string(),
...
const domaine = defineCollection({
  loader: glob({ pattern: "*.yaml", base: "./src/content/domaine" }),
  schema: ({ image }) =>
    z.object({
      theme: z.object({
    ...
    z.object({
      ...
      booking: z.object({
        ...
        config: z.object({
          ...
          ctaHref: z.string(),
          callLabel: z.string(),
          callHref: z.string().default("tel:+33468000000"),
